...
display_name: 多文件实质差异对比
display_name_en: Multi-document Semantic Diff
...
description_zh: 对多份文件或版本进行事实、规则、范围、数字、公式和语义层面的实质差异对比。
description_en: Compare documents and versions at fact, rule, scope, number, formula, and meaning level.
version: 1.0.0
