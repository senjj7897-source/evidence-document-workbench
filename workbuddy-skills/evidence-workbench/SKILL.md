...
display_name: 证据工作台
display_name_en: Evidence Workbench
...
description_zh: 面向高要求文档，统筹多文件对比、证据审查、修改优化、文风积累和知识状态治理。
description_en: Orchestrate evidence-grounded document comparison, review, improvement, style memory, and knowledge governance.
version: 1.0.0
